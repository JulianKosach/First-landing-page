...
(function($, undefined) {
    ...
    function addFormThanks(id) {
        if (id == "form1") {
            ...
            showThanks("form1 .thanks");
        } else if (id == "form2") {
            $("body").append('<section id="sec3-thanks"><div><h2>Заявка принята</h2><h3>Мы вышлем вам КП в течение 24 часов</h3></div></section>');
            showThanks("sec3-thanks");
        } else if (id == "form3") {
            $("body").append('<section id="sec10-thanks"><div><h2>Заявка принята</h2><h3>Наш менеджер сориентирует вас <br> по цене в течение 25 минут</h3></div></section>');
            showThanks("sec10-thanks");
        } else if (id == "form4") {
            $("#form4").append('<div class="thanks"><h4>Заявка принята</h4><p>Мы свяжемся с Вами в ближайшее время!</p></div>');
            showThanks("form4 .thanks");
        };
    ...
    $(document).ready(function() {
        ...
        var slider1 = $('#sec2 .ul-wrap ul').bxSlider({
            infiniteLoop: true,
            controls: false,
            pager: true,
            speed: 500,
            ...
            onSlideBefore: function($slideElement, oldIndex, newIndex) {
                $(".lazy").lazyload();
                if ($('#sec2 .ul-wrap ul').find('iframe').length == 0) return;
                $('#sec2 .ul-wrap ul').find('iframe').each(function() {
                    $(this).remove();
                });
                $('#sec2 .ul-wrap ul').find(".btn-play").each(function() {
        ...
        var slider3 = $('#sec12 .ul-wrap ul').bxSlider({
            infiniteLoop: true,
            nextSelector: '#lead-btn-right',
            prevSelector: '#lead-btn-left',
            nextText: '',
            prevText: '',
            controls: true,
            pager: false,
