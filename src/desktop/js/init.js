...
WebFont.load({
    google: {
        families: ['Merriweather:400:latin,cyrillic', 'Open+Sans:300,400:latin,cyrillic', 'Roboto:900:latin,cyrillic']
    },
    active: function() {
...
function initalize() {
    ...
    ! function(e, t, n) {
        ...
        "js/libs.js",
        "js/main.js",
        "https://maps.googleapis.com/maps/api/js?key=AIzaSyCiOcdnStQGF3o4icWg0NXTfMJNvYuDsp4",
        "js/map.js"
    ]);
